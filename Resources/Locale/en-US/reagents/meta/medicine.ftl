...
reagent-desc-tricordrazine = A wide-spectrum stimulant, originally derived from cordrazine. Heals minor brute, burn, and poison damage while the patient is alive, but has no effect on critical or dead patients. Best used as an additive to other chemicals.
