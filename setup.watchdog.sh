...
echo "    3. Start the watchdog:"
echo "         sudo systemctl start ss14-watchdog"
echo "       (vs-2f8.1: builds download from https://ss14.zig.computer/cdn/"
echo "        automatically — no manual binaries/ drop required)"
echo "    4. Verify:  systemctl is-active ss14-watchdog"
